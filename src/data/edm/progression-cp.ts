export type EdmSemaine = {
  ...
  sous_theme: string
  competences: string
  domaine: 'le_temps' | 'lespace' | 'le_vivant' | 'la_matiere' | 'la_societe'
}

export const EDM_PROGRESSION_CP: EdmSemaine[] = [
  { numero: 1, theme: 'Moi', sous_theme: 'Mon corps', competences: 'Identifier les parties du corps. Se repérer dans l\'espace proche.', domaine: 'lespace' },
  { numero: 2, theme: 'Moi', sous_theme: 'Mes sens', competences: 'Utiliser ses sens pour explorer son environnement.', domaine: 'le_vivant' },
  { numero: 3, theme: 'L\'école', sous_theme: 'Se repérer dans l\'école', competences: 'Se repérer dans un espace connu. Lire un plan simple.', domaine: 'lespace' },
  ...
  { numero: 12, theme: 'L\'espace', sous_theme: 'Mon quartier / mon village', competences: 'Se repérer dans l\'espace local. Utiliser des repères spatiaux.', domaine: 'lespace' },
  ...
  { numero: 20, theme: 'L\'espace', sous_theme: 'La France — paysages', competences: 'Identifier différents types de paysages (mer, montagne, plaine). Localiser sur une carte simple.', domaine: 'lespace' },
  ...
  { numero: 26, theme: 'L\'espace', sous_theme: 'L\'Europe — introduction', competences: 'Situer la France en Europe. Découvrir quelques pays voisins.', domaine: 'lespace' },
  ...
  { numero: 30, theme: 'L\'espace', sous_theme: 'Ville et campagne', competences: 'Comparer la ville et la campagne. Identifier les activités humaines selon les espaces.', domaine: 'lespace' },
