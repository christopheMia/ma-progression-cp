    ...
    return (
      <div className="space-y-3">
        ...
        <button onClick={() => setEditing(true)}
          className="text-sm border border-blue-300 text-blue-700 rounded-lg px-4 py-2 hover:bg-blue-50">
          Changer de manuel
        </button>
      </div>
    )
  ...
  return (
    <div className="space-y-4">
      ...
      {!confirmed ? (
        ...
        <p className="text-sm text-blue-700">Régénération de la progression…</p>
      ) : (
        <>
